...
var PlainViewModel = function (_DisposableViewModel) {
  ...
  function PlainViewModel(root, params, attrs) {
    ...
    _this.unwrapParams.forEach(function (name) {
      if ((0, _util.isSubscribable)(_this[name])) {
...
var childrenUtil = function () {
  function childrenUtil() {
    _classCallCheck(this, childrenUtil);
  }

  _createClass(childrenUtil, null, [{
    key: 'output',
...
var childrenBinding = function () {
  function childrenBinding(ko, util) {
    _classCallCheck(this, childrenBinding);
...
exports.childrenUtil = childrenUtil;
...
var _initialize = __webpack_require__(49);

var _children = __webpack_require__(2);

var _childrenTransform = __webpack_require__(48);

var _childrenFilter = __webpack_require__(47);

var _applyBindings = __webpack_require__(46);

var _applyAttributes = __webpack_require__(45);

var _ripple2 = __webpack_require__(50);

function registerBindings(ko) {
  ko.bindingHandlers['mdc-initialize'] = new _initialize.initializeBinding(ko, _initialize.initializeUtil);
  ko.virtualElements.allowedBindings['mdc-initialize'] = true;

  ko.bindingHandlers['mdc-children'] = new _children.childrenBinding(ko, _children.childrenUtil);
  ...
  ko.bindingHandlers['mdc-children-filter'] = new _childrenFilter.childrenFilterBinding(ko, _childrenFilter.childrenFilterUtil);
  ko.virtualElements.allowedBindings['mdc-children-filter'] = true;

  ko.bindingHandlers['mdc-bindings'] = new _applyBindings.applyBindingsBinding(ko, function (element) {
    return element;
  }, true);

  ko.bindingHandlers['mdc-container-bindings'] = new _applyBindings.applyBindingsBinding(ko, function (element) {
    return element.parentNode;
  });
  ko.virtualElements.allowedBindings['mdc-container-bindings'] = true;

  ko.bindingHandlers['mdc-attrs'] = new _applyAttributes.applyAttributesBinding(ko, function (element) {
    return element;
  }, true);

  ko.bindingHandlers['mdc-container-attrs'] = new _applyAttributes.applyAttributesBinding(ko, function (element) {
    return element.parentNode;
  });
  ko.virtualElements.allowedBindings['mdc-container-attrs'] = true;

  ko.bindingHandlers['mdc-ripple'] = new _ripple2.rippleBinding(ko, _ripple2.rippleUtil);
}
...
var TextfieldViewModel = function (_ComponentViewModel) {
  ...
  _createClass(TextfieldViewModel, [{
    ...
    value: function initialize() {
      if (this.fullwidth && !this.label) {
        var labelText = this.labelElement_.textContent;
        this.textElement_.setAttribute('aria-label', labelText);
        this.textElement_.setAttribute('placeholder', labelText);
      }
    }
  }, {
    key: 'childrenTransform',
    value: function childrenTransform(children) {
      var _this2 = this;
      ...
      children.forEach(function (child) {
        if (child.nodeType == 1 && child.tagName == 'P') {
          ...
          child.setAttribute('id', _this2.attrs['aria-controls']);
          result.push(child);
        }
      });
...
exports.ToolbarViewModel = exports.ToolbarTemplate = undefined;
...
var ToolbarViewModel = function (_ComponentViewModel) {
  _inherits(ToolbarViewModel, _ComponentViewModel);

  function ToolbarViewModel() {
    _classCallCheck(this, ToolbarViewModel);

    return _possibleConstructorReturn(this, (ToolbarViewModel.__proto__ || Object.getPrototypeOf(ToolbarViewModel)).apply(this, arguments));
  }

  _createClass(ToolbarViewModel, [{
    key: 'extend',
    value: function extend() {
      if (this.waterfall) {
        this.fixed = true;
    ...
    value: function initialize() {
      ...
      if (this.flexible && (0, _util.isSubscribable)(this.ratio)) {
        this.instance.listen('MDCToolbar:change', function (evt) {
          _this2.ratio(evt.detail.flexibleExpansionRatio);
        });
      }
    }
  }, {
    key: 'createTitleNode_',
    value: function createTitleNode_(text) {
    ...
    key: 'wrapTextNodes_',
    value: function wrapTextNodes_(nodes) {
      var _this3 = this;
      ...
      nodes.forEach(function (node) {
        [].concat(_toConsumableArray(node.childNodes)).forEach(function (child) {
          if (child.nodeType == 3 && child.textContent.match(/[^\s]/)) {
            ...
            var titleNode = _this3.createTitleNode_(text);
    ...
    key: 'listChildren_',
    value: function listChildren_(parents) {
      var children = [];
      parents.forEach(function (parent) {
        if (parent.children.length) {
          children = children.concat([].concat(_toConsumableArray(parent.children)));
        }
      });
    ...
    key: 'wrapAsSections_',
    value: function wrapAsSections_(nodes) {
      var _this4 = this;
      ...
      nodes.forEach(function (node) {
        ...
        if (node.tagName && node.tagName == 'SECTION') {
          ...
          var wrapped = document.createElement('SECTION');
          ...
          [].concat(_toConsumableArray(node.attributes)).forEach(function (attr) {
            if (_this4.sectionOnlyAttributes_.indexOf(attr.name) !== -1) {
    ...
    key: 'combineNonDivs_',
    value: function combineNonDivs_(nodes) {
      var result = [];

      var group = [];
      nodes.forEach(function (node, i) {
        var isDiv = node.nodeType == 1 && node.tagName == 'DIV';
        var isEmptyText = node.nodeType == 3 && !node.textContent.match(/[^\s]/);
    ...
    key: 'childrenTransform',
    value: function childrenTransform(children) {
      var divs = this.combineNonDivs_(children);
      ...
      var divChildren = this.listChildren_(divs);
      var sections = this.wrapAsSections_(divChildren);
      this.wrapTextNodes_(sections);

      return divs;
    }
  }, {
    key: 'sectionOnlyAttributes_',
    get: function get() {
...
exports.ToolbarTemplate = _toolbar2.default;
...
var applyAttributesBinding = function () {
  function applyAttributesBinding(ko, nodeAccessor) {
    _classCallCheck(this, applyAttributesBinding);
  ...
  _createClass(applyAttributesBinding, [{
    key: 'preprocess',
    value: function preprocess(value, name, addBindingCallback) {
      return value || 'attrs';
    }
  }, {
    key: 'init',
  ...
  return applyAttributesBinding;
}();

exports.applyAttributesBinding = applyAttributesBinding;
...
var applyBindingsBinding = function () {
  function applyBindingsBinding(ko, nodeAccessor) {
    var forceBindings = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;

    _classCallCheck(this, applyBindingsBinding);
  ...
  _createClass(applyBindingsBinding, [{
    key: 'preprocess',
    value: function preprocess(value, name, addBindingCallback) {
    ...
    value: function init(element, valueAccessor, allBindings, viewModel, bindingContext) {
      ...
      if (this.forceBindings) {
        Object.keys(bindings).forEach(function (name) {
          if (!_this.ko.isSubscribable(bindings[name])) {
            bindings[name] = _this.ko.observable(bindings[name]);
          }
        });
      }
  ...
  return applyBindingsBinding;
}();

exports.applyBindingsBinding = applyBindingsBinding;
...
exports.childrenFilterUtil = exports.childrenFilterBinding = undefined;
...
var childrenFilterUtil = function (_childrenUtil) {
  _inherits(childrenFilterUtil, _childrenUtil);

  function childrenFilterUtil() {
    _classCallCheck(this, childrenFilterUtil);

    return _possibleConstructorReturn(this, (childrenFilterUtil.__proto__ || Object.getPrototypeOf(childrenFilterUtil)).apply(this, arguments));
  }

  _createClass(childrenFilterUtil, null, [{
    key: 'test',
    value: function test(element, condition) {
  ...
  return childrenFilterUtil;
}(_children.childrenUtil);

var childrenFilterBinding = function () {
  function childrenFilterBinding(ko, util) {
    _classCallCheck(this, childrenFilterBinding);
  ...
  _createClass(childrenFilterBinding, [{
    key: 'init',
    value: function init(element, valueAccessor, allBindings, viewModel, bindingContext) {
      var _this2 = this;
      ...
      if (children.length) {
        children.forEach(function (child) {
          if (_this2.util.test(child, condition)) {
            result.push(child);
          }
        });
      }
  ...
  return childrenFilterBinding;
}();

exports.childrenFilterBinding = childrenFilterBinding;
exports.childrenFilterUtil = childrenFilterUtil;
...
exports.childrenTransformUtil = exports.childrenTransformBinding = undefined;
...
var childrenTransformUtil = function (_childrenUtil) {
  _inherits(childrenTransformUtil, _childrenUtil);

  function childrenTransformUtil() {
    _classCallCheck(this, childrenTransformUtil);

    return _possibleConstructorReturn(this, (childrenTransformUtil.__proto__ || Object.getPrototypeOf(childrenTransformUtil)).apply(this, arguments));
  }
      ...
      nodes.forEach(function (node) {
        ...
        if (depth < maxDepth) {
          if (node.children && node.children.length) {
            _this2.makeList(result, [].concat(_toConsumableArray(node.children)), maxDepth, depth + 1);
          }
        }
      });
    }
...
exports.initializeUtil = exports.initializeBinding = undefined;
...
var initializeUtil = function () {
  function initializeUtil() {
    _classCallCheck(this, initializeUtil);
  }

  _createClass(initializeUtil, null, [{
    key: 'getWrapper',
    value: function getWrapper(root) {
      return root.children[0];
    }
  }, {
    key: 'instantiate',
    value: function instantiate(componentClass, element) {
      return componentClass.attachTo(element);;
    }
  }, {
    key: 'initialize',
    value: function initialize(instance, viewModel, bindingContext) {
      viewModel.instance = instance;
      viewModel.initialize(bindingContext[_children.constants.PARENT_VIEW_MODEL]);
    }
  }]);

  return initializeUtil;
}();

var initializeBinding = function () {
  function initializeBinding(ko, util) {
    _classCallCheck(this, initializeBinding);
  ...
  _createClass(initializeBinding, [{
    key: 'init',
    value: function init(element, valueAccessor, allBindings, viewModel, bindingContext) {
      var vm = bindingContext.$component;
      var root = vm.root;
      var MDCComponent = vm.MDCComponent;

      var wrapper = this.util.getWrapper(root);
      var instance = this.util.instantiate(MDCComponent, wrapper);
...
exports.initializeUtil = initializeUtil;
...
exports.rippleUtil = exports.rippleBinding = undefined;
...
var rippleUtil = function () {
  function rippleUtil() {
    _classCallCheck(this, rippleUtil);
  }

  _createClass(rippleUtil, null, [{
    key: 'instantiate',
    value: function instantiate(rippleClass, element) {
...
var rippleBinding = function () {
  function rippleBinding(ko, util) {
    _classCallCheck(this, rippleBinding);
  ...
  _createClass(rippleBinding, [{
    key: 'init',
    value: function init(element, valueAccessor, allBindings, viewModel, bindingContext) {
      var ripple = this.util.instantiate(_ripple.MDCRipple, element);
      element['MDCRipple'] = ripple;

      this.ko.utils.domNodeDisposal.addDisposeCallback(element, function () {
        element['MDCRipple'].destroy();
      });
    }
  }]);

  return rippleBinding;
}();

exports.rippleBinding = rippleBinding;
exports.rippleUtil = rippleUtil;
...
var _mdcKnockoutAugment = __webpack_require__(14);

var _mdcKnockoutAugment2 = _interopRequireDefault(_mdcKnockoutAugment);

var _mdcKnockoutTextfield = __webpack_require__(22);

var _mdcKnockoutFormField = __webpack_require__(19);

var _mdcKnockoutCheckbox = __webpack_require__(16);

var _mdcKnockoutRadio = __webpack_require__(20);

var _mdcKnockoutToolbar = __webpack_require__(23);

var _mdcKnockoutSwitch = __webpack_require__(21);

var _mdcKnockoutButton = __webpack_require__(15);

var _mdcKnockoutElevation = __webpack_require__(17);

var _mdcKnockoutFab = __webpack_require__(18);
...
_mdcKnockoutAugment2.default.registerComponent(ko, 'mdc-toolbar', (0, _mdcKnockoutToolbar.ToolbarTemplate)(), _mdcKnockoutToolbar.ToolbarViewModel, _toolbar.MDCToolbar);
//
...
function _template() {
  return "<!-- ko mdc-container-bindings --><!-- /ko -->\n<!-- ko mdc-container-attrs --><!-- /ko -->\n<!-- ko mdc-children --><!-- /ko -->\n";
};
